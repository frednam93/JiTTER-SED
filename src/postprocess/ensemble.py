...
if __name__ == "__main__":
    """ Ensemble the results in the root_dir. Make sure that the structure of the root_dir is like:
        root_dir/
            ...
            ...
    """
    root_dir = '/home/rtx3090x3/nhu_dcase/mat-SED/exps/dcase2024/ensemble/val/sub'  # Path to the main folder containing subfolders with prediction results
    output_dir = '/home/rtx3090x3/nhu_dcase/mat-SED/exps/dcase2024/ensemble/val/res/0.7-0.3'  # Path to the output folder to save the ensemble results
