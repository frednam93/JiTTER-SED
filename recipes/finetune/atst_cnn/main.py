...
from recipes.finetune.atst_cnn.setting import *
from recipes.finetune.atst_cnn.train import ATST_CNN_Trainer
...
if __name__ == "__main__":
    ...
    # set network
    net, ema_net = get_models_atst_cnn(configs)
    ...
    model_path = "/home/rtx3090x3/nhu_dcase/mat-SED/pretrained_model/atst/stage_2_wo_external.ckpt"
    ...
    ##############################                TRAIN/VALIDATION                ##############################
    trainer = ATST_CNN_Trainer(optimizer=None,
                               my_logger=my_logger,
                               net=net,
                               ema_net=ema_net,
                               config=configs,
